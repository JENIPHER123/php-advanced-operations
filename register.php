       ...
       ?>
        <div class="col-lg-6 mb-5 mb-lg-0">
          ...
          <p style="color: hsl(217, 10%, 50.8%)">
            I designed this project with the sole purpose of tackling a bunch of common issues found when using PHP as a programming language. Get to learn with me by registering. <br> Check out my website protfilio:  <a href="https://jenipher-kuki.000webhostapp.com/" target="_blank" rel="noopener noreferrer">@Jenipher_website</a>. <br>Follow me on my github handle to get fast access to all my projects :  <a href="https://jenipher-kuki.000webhostapp.com/" target="_blank" rel="noopener noreferrer">@Jenipher_github </a>.  
          </p>
        </div>
