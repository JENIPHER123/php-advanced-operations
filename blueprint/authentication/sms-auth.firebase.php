          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>SMS Authentication <small>firebase</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <!-- Smart Wizard -->
                    <p>SMS authentication and setting code using firebase and php.</p>
                    <div id="wizard" class="form_wizard wizard_horizontal">
                      ...
                      <div id="step-1" class="pt-5 mt-5 pb-5">
                        <form class="form-horizontal form-label-left">
                          ...
                          <div class="form-group row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Enter your Phone NO:</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="middle-name" class="form-control col" type="text" name="middle-name">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Confirm Phone NO:</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="middle-name" class="form-control col" type="text" name="middle-name">
                            </div>
                          </div>
                      ...
                      <form class="form-horizontal form-label-left">
                        ...
                        <div class="form-group row">
                          <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">My Phone NO:</label>
                          <div class="col-md-6 col-sm-6 ">
                            <input id="middle-name" class="form-control col"readonly type="text" name="middle-name">
                          </div>
                        </div>
