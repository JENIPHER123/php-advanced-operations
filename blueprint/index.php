        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          <div class="card">
            <div class="card-body py-5 px-md-5">
              <!-- login form -->
              <form action="php/access.php" method="post"><!-- redirect to login function -->
                <!-- 2 column grid layout with text inputs for the first and last names -->
                <div class="row">
                  <div class="col-md-12 mb-5">
                    <div class="h1 fw-bold text-center">ACCESS CODE</div>
                  </div>
                ...
                <div class="form-outline mb-4">
                  <input type="text"name="access_code" id="form3Example3" class="form-control" />
                  <label class="form-label" for="form3Example3">Enter Access Code</label>
                </div>
